<div class="min-h-full flex item-center justify-center py-12 px-4 sn:px-6 lg:px-8">
	<div class="max-w-md w-full space-y-8">
		<div>
			<img src="" alt="" />
			<h2 class="mt-6 text-center text-3xl font-bold text-gray-900">Register for RAtracker</h2>
		</div>
